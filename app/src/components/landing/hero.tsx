...
const Hero = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full h-[30rem] bg-gradient-to-b dark:from-black dark:via-slate-900 dark:to-slate-950 from-slate-200 to-white">
      {isLoggedIn ? (
